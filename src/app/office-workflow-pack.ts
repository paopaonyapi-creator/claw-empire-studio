...
const DEPARTMENT_PERSON_NAME_POOL: Partial<Record<string, Localized[]>> = {
  planning: [
    { ko: "세이지", en: "Sage", ja: "セージ", zh: "赛吉" , th: "Sage" },
    { ko: "미나", en: "Mina", ja: "ミナ", zh: "米娜" , th: "Mina" },
    { ko: "주노", en: "Juno", ja: "ジュノ", zh: "朱诺" , th: "Juno" },
    { ko: "리안", en: "Rian", ja: "リアン", zh: "里安" , th: "Rian" },
    { ko: "하루", en: "Haru", ja: "ハル", zh: "晴" , th: "Haru" },
    { ko: "노아", en: "Noa", ja: "ノア", zh: "诺亚" , th: "Noa" },
  ],
  dev: [
    { ko: "아리아", en: "Aria", ja: "アリア", zh: "阿莉娅" , th: "Aria" },
    { ko: "테오", en: "Theo", ja: "テオ", zh: "西奥" , th: "Theo" },
    { ko: "카이", en: "Kai", ja: "カイ", zh: "凯" , th: "Kai" },
    { ko: "리암", en: "Liam", ja: "リアム", zh: "利亚姆" , th: "Liam" },
    { ko: "세나", en: "Sena", ja: "セナ", zh: "塞娜" , th: "Sena" },
    { ko: "로완", en: "Rowan", ja: "ローワン", zh: "罗恩" , th: "Rowan" },
  ],
  design: [
    { ko: "도로", en: "Doro", ja: "ドロ", zh: "多罗" , th: "Doro" },
    { ko: "루나", en: "Luna", ja: "ルナ", zh: "露娜" , th: "Luna" },
    { ko: "픽셀", en: "Pixel", ja: "ピクセル", zh: "像素" , th: "Pixel" },
    { ko: "유나", en: "Yuna", ja: "ユナ", zh: "优娜" , th: "Yuna" },
    { ko: "미로", en: "Miro", ja: "ミロ", zh: "米洛" , th: "Miro" },
    { ko: "아이리스", en: "Iris", ja: "アイリス", zh: "爱丽丝" , th: "Iris" },
  ],
  qa: [
    { ko: "스피키", en: "Speaky", ja: "スピーキー", zh: "斯皮奇" , th: "Speaky" },
    { ko: "호크", en: "Hawk", ja: "ホーク", zh: "霍克" , th: "Hawk" },
    { ko: "베라", en: "Vera", ja: "ヴェラ", zh: "薇拉" , th: "Vera" },
    { ko: "퀸", en: "Quinn", ja: "クイン", zh: "奎因" , th: "Quinn" },
    { ko: "토리", en: "Tori", ja: "トリ", zh: "托莉" , th: "Tori" },
    { ko: "하윤", en: "Hayoon", ja: "ハユン", zh: "夏允" , th: "Hayoon" },
  ],
  operations: [
    { ko: "아틀라스", en: "Atlas", ja: "アトラス", zh: "阿特拉斯" , th: "Atlas" },
    { ko: "나리", en: "Nari", ja: "ナリ", zh: "娜莉" , th: "Nari" },
    { ko: "오웬", en: "Owen", ja: "オーウェン", zh: "欧文" , th: "Owen" },
    { ko: "다미", en: "Dami", ja: "ダミ", zh: "达米" , th: "Dami" },
    { ko: "키라", en: "Kira", ja: "キラ", zh: "琪拉" , th: "Kira" },
    { ko: "솔", en: "Sol", ja: "ソル", zh: "索尔" , th: "Sol" },
  ],
  devsecops: [
    { ko: "볼트S", en: "VoltS", ja: "ボルトS", zh: "伏特S" , th: "VoltS" },
    { ko: "시온", en: "Sion", ja: "シオン", zh: "锡安" , th: "Sion" },
    { ko: "녹스", en: "Knox", ja: "ノックス", zh: "诺克斯" , th: "Knox" },
    { ko: "레이븐", en: "Raven", ja: "レイヴン", zh: "渡鸦" , th: "Raven" },
    { ko: "미라", en: "Mira", ja: "ミラ", zh: "米拉" , th: "Mira" },
    { ko: "알렉스", en: "Alex", ja: "アレックス", zh: "亚历克斯" , th: "Alex" },
  ],
};
...
const PACK_SEED_PROFILE: Partial<Record<WorkflowPackKey, SeedProfile>> = {
  report: {
    ...
    tone: {
      ...
      th: "ให้ความสำคัญกับคุณภาพหลักฐานและความสมบูรณ์ของเอกสาร",
    },
  },
  web_research_report: {
    nameOffset: 1,
    tone: {
      ...
      zh: "聚焦来源可信度与事实核验。",
      th: "เน้นความน่าเชื่อถือของแหล่งข้อมูลและการตรวจสอบข้อเท็จจริง",
    },
  },
  novel: {
    nameOffset: 2,
    tone: {
      ...
      zh: "最重视叙事沉浸感与角色一致性。",
      th: "ให้คุณค่ากับการจมดิ่มในเรื่องเล่าและความสม่ำเสมอของตัวละครมากที่สุด",
    },
  },
  video_preprod: {
    nameOffset: 3,
    tone: {
      ...
      th: "ให้ความสำคัญกับคุณภาพสตอรี่บอร์ด องค์ประกอบช็อต และประสิทธิภาพการผลิต",
    },
  },
  roleplay: {
    nameOffset: 4,
    tone: {
      ...
      zh: "优先保障角色沉浸感与对话节奏。",
      th: "ให้ความสำคัญกับการจมดิ่มในตัวละครและจังหวะบทสนทนา",
    },
  },
};
...
const PACK_PRESETS: Record<WorkflowPackKey, PackPreset> = {
  development: {
    ...
    summary: {
      ...
      ja: "標準の開発組織",
      zh: "默认开发组织",
      th: "โครงสร้างองค์กรวิศวกรรมเริ่มต้น",
    },
  ...
  report: {
    ...
    departments: {
      planning: {
        name: { ko: "편집기획실", en: "Editorial Planning", ja: "編集企画室", zh: "编辑企划室" , th: "กองบรรณาธิการ" },
        icon: "📚",
        agentPrefix: { ko: "편집 PM", en: "Editorial PM", ja: "編集PM", zh: "编辑PM" , th: "PM กองบรรณาธิการ" },
        avatarPool: ["📚", "🗂️", "🧭"],
      },
      dev: {
        name: { ko: "리서치엔진팀", en: "Research Engine", ja: "リサーチエンジン", zh: "调研引擎组" , th: "ทีมวิจัย" },
        icon: "🧠",
        agentPrefix: { ko: "리서처", en: "Researcher", ja: "リサーチャー", zh: "研究员" , th: "นักวิจัย" },
        avatarPool: ["🧠", "📊", "📝"],
      },
      design: {
        name: { ko: "문서디자인팀", en: "Doc Design", ja: "ドキュメントデザイン", zh: "文档设计组" , th: "ทีมออกแบบเอกสาร" },
        icon: "🧾",
        agentPrefix: { ko: "문서 디자이너", en: "Doc Designer", ja: "資料デザイナー", zh: "文档设计师" , th: "นักออกแบบเอกสาร" },
        avatarPool: ["🧾", "🎨", "📐"],
      },
      qa: {
        name: { ko: "검수팀", en: "Review Desk", ja: "レビュー班", zh: "审校组" , th: "ทีมตรวจสอบ" },
        icon: "🔎",
        agentPrefix: { ko: "검수관", en: "Reviewer", ja: "レビュア", zh: "审校员" , th: "ผู้ตรวจสอบ" },
        avatarPool: ["🔎", "✅", "🧪"],
      },
    },
    staff: {
  ...
  web_research_report: {
    ...
    summary: {
      ...
      ja: "情報源収集と根拠検証中心",
      zh: "以来源收集与证据校验为核心",
      th: "การรวบรวมแหล่งข้อมูลและตรวจสอบอ้างอิง",
    },
    roomThemes: {
    ...
    departments: {
      planning: {
        name: { ko: "조사전략실", en: "Research Strategy", ja: "調査戦略室", zh: "调研战略室" , th: "กลยุทธ์วิจัย" },
        icon: "🧭",
        agentPrefix: { ko: "전략 분석가", en: "Strategy Analyst", ja: "戦略アナリスト", zh: "策略分析师" , th: "นักวิเคราะห์กลยุทธ์" },
        avatarPool: ["🧭", "🗺️", "📌"],
      },
      dev: {
        name: { ko: "크롤링팀", en: "Crawler Team", ja: "クロール班", zh: "爬取组" , th: "ทีมรวบรวมข้อมูล" },
        icon: "🕸️",
        agentPrefix: { ko: "수집 엔지니어", en: "Collection Engineer", ja: "収集エンジニア", zh: "采集工程师" , th: "วิศวกรรวบรวมข้อมูล" },
        avatarPool: ["🕸️", "🔗", "🧠"],
      },
      qa: {
        name: { ko: "팩트체크팀", en: "Fact Check", ja: "ファクトチェック", zh: "事实核验组" , th: "ตรวจสอบข้อเท็จจริง" },
        icon: "✅",
        agentPrefix: { ko: "검증관", en: "Verifier", ja: "検証官", zh: "核验员" , th: "ผู้ตรวจสอบ" },
        avatarPool: ["✅", "🔍", "📎"],
      },
    },
    staff: {
  ...
  novel: {
    ...
    summary: {
      ...
      ja: "世界観・キャラ・物語中心",
      zh: "世界观/角色/叙事导向",
      th: "การสร้างโลก ตัวละคร และโครงสร้างเรื่อง",
    },
    roomThemes: {
    ...
    departments: {
      planning: {
        name: { ko: "세계관실", en: "Worldbuilding", ja: "世界観室", zh: "世界观组" , th: "สร้างโลก" },
        icon: "🌌",
        agentPrefix: { ko: "세계관 작가", en: "Lore Writer", ja: "設定作家", zh: "设定作者" , th: "นักเขียนโลก" },
        avatarPool: ["🌌", "📜", "🧭"],
      },
      dev: {
        name: { ko: "서사엔진팀", en: "Narrative Engine", ja: "物語エンジン", zh: "叙事引擎组" , th: "เครื่องจักรเรื่องเล่า" },
        icon: "✍️",
        agentPrefix: { ko: "서사 설계자", en: "Narrative Architect", ja: "物語設計者", zh: "叙事架构师" , th: "สถาปนิกเรื่องเล่า" },
        avatarPool: ["✍️", "🖋️", "📘"],
      },
      design: {
        name: { ko: "캐릭터 아트팀", en: "Character Art", ja: "キャラアート", zh: "角色美术组" , th: "ทีมวาดตัวละคร" },
        icon: "🎭",
        agentPrefix: { ko: "캐릭터 디자이너", en: "Character Designer", ja: "キャラデザ", zh: "角色设计师" , th: "นักออกแบบตัวละคร" },
        avatarPool: ["🎭", "🧵", "🎨"],
      },
      qa: {
        name: { ko: "톤 검수팀", en: "Tone QA", ja: "トーン検証", zh: "语气审校组" , th: "ตรวจสอบโทน" },
        icon: "🪶",
        agentPrefix: { ko: "문체 검수관", en: "Style Reviewer", ja: "文体レビュア", zh: "文风审校员" , th: "ผู้ตรวจสอบสไตล์" },
        avatarPool: ["🪶", "📖", "✅"],
      },
    },
    staff: {
  ...
  video_preprod: {
    ...
    summary: {
      ...
      ja: "コンテ・ショットリスト中心",
      zh: "分镜与镜头清单导向",
      th: "การตั้งค่าที่เน้นสตอรี่บอร์ดและรายการช็อต",
    },
    roomThemes: {
    ...
    departments: {
      planning: {
        name: { ko: "프리프로덕션팀", en: "Pre-production", ja: "プリプロ班", zh: "前期策划组" , th: "พรีโปรดักชั่น" },
        icon: "🎬",
        agentPrefix: { ko: "프로듀서", en: "Producer", ja: "プロデューサ", zh: "制片" , th: "Producer" },
        avatarPool: ["🎬", "📽️", "🧭"],
      },
      dev: {
        name: { ko: "씬 엔진팀", en: "Scene Engine", ja: "シーン設計", zh: "场景引擎组" , th: "Scene Engine" },
        icon: "🎞️",
        agentPrefix: { ko: "씬 디렉터", en: "Scene Director", ja: "シーン監督", zh: "场景导演" , th: "Scene Director" },
        avatarPool: ["🎞️", "🧱", "🔧"],
      },
      design: {
        name: { ko: "아트/촬영팀", en: "Art & Camera", ja: "アート撮影", zh: "美术摄影组" , th: "Art & Camera" },
        icon: "📷",
        agentPrefix: { ko: "촬영 디자이너", en: "Camera Designer", ja: "撮影デザイナ", zh: "摄影设计师" , th: "Camera Designer" },
        avatarPool: ["📷", "🎨", "💡"],
      },
      qa: {
        name: { ko: "컷 검수팀", en: "Cut QA", ja: "カット検証", zh: "镜头审校组" , th: "Cut QA" },
        icon: "🧪",
        agentPrefix: { ko: "컷 검수관", en: "Cut Reviewer", ja: "カットレビュア", zh: "镜头审校员" , th: "Cut Reviewer" },
        avatarPool: ["🧪", "✅", "📌"],
      },
    },
    staff: {
  ...
  roleplay: {
    ...
    departments: {
      planning: {
        name: { ko: "캐릭터기획실", en: "Character Planning", ja: "キャラ企画室", zh: "角色企划室" , th: "Character Planning" },
        icon: "🎭",
        agentPrefix: { ko: "캐릭터 플래너", en: "Character Planner", ja: "キャラ企画", zh: "角色策划" , th: "Character Planner" },
        avatarPool: ["🎭", "🧠", "📜"],
      },
      dev: {
        name: { ko: "대사엔진팀", en: "Dialogue Engine", ja: "会話エンジン", zh: "对话引擎组" , th: "Dialogue Engine" },
        icon: "🗣️",
        agentPrefix: { ko: "대사 연출가", en: "Dialogue Director", ja: "台詞演出", zh: "台词导演" , th: "Dialogue Director" },
        avatarPool: ["🗣️", "💬", "🎙️"],
      },
      design: {
        name: { ko: "연출아트팀", en: "Stage Art", ja: "演出アート", zh: "演出美术组" , th: "Stage Art" },
        icon: "🎨",
        agentPrefix: { ko: "연출 디자이너", en: "Stage Designer", ja: "演出デザイナ", zh: "演出设计师" , th: "Stage Designer" },
        avatarPool: ["🎨", "✨", "🎬"],
      },
      qa: {
        name: { ko: "캐릭터검수팀", en: "Character QA", ja: "キャラ検証", zh: "角色审校组" , th: "Character QA" },
        icon: "🔐",
        agentPrefix: { ko: "설정 검수관", en: "Lore Reviewer", ja: "設定レビュア", zh: "设定审校员" , th: "Lore Reviewer" },
        avatarPool: ["🔐", "✅", "🧪"],
      },
    },
    staff: {
