...
const LOCALE_TEXT = {
  ...
  statsEmployees: { ko: "직원", en: "Staff", ja: "スタッフ", zh: "员工" , th: "Staff" },
  ...
  hint: {
    ...
    th: "WASD/Arrow/Virtual Pad: CEO Move  |  Enter: Interact",
  },
  mobileEnter: {
    ko: "Enter",
    en: "Enter",
  ...
  role: {
    team_leader: { ko: "팀장", en: "Lead", ja: "リーダー", zh: "组长" , th: "Lead" },
    senior: { ko: "시니어", en: "Senior", ja: "シニア", zh: "资深" , th: "Senior" },
    junior: { ko: "주니어", en: "Junior", ja: "ジュニア", zh: "初级" , th: "Junior" },
    intern: { ko: "인턴", en: "Intern", ja: "インターン", zh: "实习" , th: "Intern" },
    part_time: { ko: "알바", en: "Part-time", ja: "アルバイト", zh: "兼职" , th: "Part-time" },
  },
  partTime: {
    ko: "알바",
    en: "Part-time",
  ...
  kickoffLines: {
    ...
    th: ["ตรวจสอบผลกระทบข้ามทีม", "แชร์ความเสี่ยง/การพึ่งพา", "จัดลำดับตารางงาน/ความสำคัญ", "กำหนดขอบเขตความรับผิดชอบ"],
  },
  reviewLines: {
    ...
    th: ["ตรวจสอบการอัปเดตเพิ่มเติม", "ตรวจร่างขั้นสุดท้ายที่อนุมัติ", "แชร์ไอเดียแก้ไข", "ตรวจสอบผลงานข้ามกัน"],
  },
  meetingTableHint: {
    ...
    zh: "📝 会议进行中：点击桌子查看纪要",
    th: "📝 Meeting live: click table for minutes",
  },
  cliUsageTitle: {
    ko: "CLI 사용량",
    en: "CLI Usage",
