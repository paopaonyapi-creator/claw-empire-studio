      ...
      <div className="mb-3 flex flex-wrap items-center gap-1.5">
        ...
        {isHiddenTask && (
          <span className="rounded-full bg-cyan-900/60 px-2 py-0.5 text-xs text-cyan-200">
            🙈 {t({ ko: "숨김", en: "Hidden", ja: "非表示", zh: "隐藏" , th: "Hidden" })}
          </span>
        )}
        {department && (
      ...
      <div className="flex flex-wrap items-center gap-1.5">
        {canRun && (
          <button
            ...
            title={t({ ko: "작업 실행", en: "Run task", ja: "タスク実行", zh: "运行任务" , th: "Run task" })}
        ...
        {canPause && (
          <button
            ...
            title={t({ ko: "작업 일시중지", en: "Pause task", ja: "タスク一時停止", zh: "暂停任务" , th: "Pause task" })}
          ...
          >
            ⏸ {t({ ko: "일시중지", en: "Pause", ja: "一時停止", zh: "暂停" , th: "หยุดชั่วคราว" })}
          </button>
        )}
        {canStop && (
          <button
            ...
            title={t({ ko: "작업 중지", en: "Cancel task", ja: "タスク停止", zh: "取消任务" , th: "Cancel task" })}
        ...
        {canResume && (
          <button
            ...
            title={t({ ko: "작업 재개", en: "Resume task", ja: "タスク再開", zh: "恢复任务" , th: "Resume task" })}
          ...
          >
            ↩ {t({ ko: "재개", en: "Resume", ja: "再開", zh: "恢复" , th: "ดำเนินต่อ" })}
          </button>
        )}
        ...
        {canHideTask && !isHiddenTask && onHideTask && (
          <button
            ...
            title={t({
              ...
              zh: "隐藏已完成/待处理/已取消任务",
              th: "Hide done/pending/cancelled task",
            })}
          ...
          >
            🙈 {t({ ko: "숨김", en: "Hide", ja: "非表示", zh: "隐藏" , th: "ซ่อน" })}
          </button>
        )}
        {canHideTask && !!isHiddenTask && onUnhideTask && (
          <button
            onClick={() => onUnhideTask(task.id)}
            title={t({ ko: "숨긴 작업 복원", en: "Restore hidden task", ja: "非表示タスクを復元", zh: "恢复隐藏任务" , th: "Restore hidden task" })}
          ...
          >
            👁 {t({ ko: "복원", en: "Restore", ja: "復元", zh: "恢复" , th: "กู้คืน" })}
          </button>
        )}
        {canDelete && (
          <button
            ...
            title={t({ ko: "작업 삭제", en: "Delete task", ja: "タスク削除", zh: "删除任务" , th: "Delete task" })}
