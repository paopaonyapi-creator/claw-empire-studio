  ...
  if (projectId && !resolvedProject) {
    setFormFeedback({
      ...
      message: t({
        ...
        zh: "找不到所选项目，请重新选择。",
        th: "The selected project was not found. Please select again.",
      }),
    });
    return;
  }
  ...
  if (!resolvedProject && projectQuery.trim() && !createNewProjectMode) {
    setFormFeedback({
      ...
      message: t({
        ...
        th: "Could not resolve the typed project. Pick from the list or clear it to continue.",
      }),
    });
    ...
    if (!projectName) {
      setFormFeedback({
        ...
        message: t({
          ...
          zh: "请输入新项目名称。",
          th: "Please enter a new project name.",
        }),
      });
      return;
    }
    if (!newProjectPath.trim()) {
      setFormFeedback({
        ...
        message: t({
          ...
          zh: "请输入新项目路径。",
          th: "Please enter a new project path.",
        }),
      });
      return;
    }
    if (!coreGoal) {
      setFormFeedback({
        ...
        message: t({
          ...
          th: "Description is required for new project creation and will be saved as the project core goal.",
        }),
      });
      return;
    }
    ...
    try {
        ...
        if (pathCheck.exists && !pathCheck.is_directory) {
          setFormFeedback({
            ...
            message: t({
              ...
              zh: "该路径不是文件夹，请输入目录路径。",
              th: "The path is not a directory. Please enter a directory path.",
            }),
          });
          return;
        }
      ...
      setFormFeedback({
        ...
        message: resolvePathHelperErrorMessage(error, {
          ...
          zh: "新项目创建失败，请检查名称/路径。",
          th: "Failed to create a new project. Please check name/path.",
        }),
      });
      return;
    } finally {
  ...
  try {
    ...
    setFormFeedback({
      ...
      message: t({
        ...
        zh: "创建任务时发生错误，请稍后重试。",
        th: "Failed to create task. Please try again shortly.",
      }),
    });
  } finally {
    setSubmitBusy(false);
